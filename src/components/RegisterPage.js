...
const roles = [
  {
    ...
    description: "Register with your medical credentials and hospital affiliation",
    icon: (
  ...
  },
  {
    ...
    description: "Create a secure patient account to manage your health records",
    icon: (
      <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
  ...
  },
  {
    ...
    description: "Register your facility to upload and manage lab reports",
    icon: (
      <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
        ...
        <div className="w-full max-w-3xl animate-fade-in">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3">
              Create a <span className="gradient-text">MediChain</span> Account
            </h1>
            <p className="text-gray-400">
              Choose your role to get started. Your identity is secured on-chain.
            </p>
          </div>
